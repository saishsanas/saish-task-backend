...
public class Task {
    ...
    public Task(UUID id, String title, String description, LocalDateTime dueDate, TaskStatus status, TaskPriority priority, LocalDateTime updated, LocalDateTime created, TaskList taskList) {
        this.id = id;
        this.title = title;
